        ...
        App.getInstance().getEngine().getBannerModel().enqueue(new Callback<BannerModel>() {
            ...
            public void onResponse(Response<BannerModel> response) {
                ...
                for (int i = 0; i < views.size(); i++) {
                    Glide.with(context).load(bannerModel.imgs.get(i)).placeholder(R.drawable.holder).error(R.drawable.holder).dontAnimate().thumbnail(0.1f).into((ImageView) views.get(i));
                }
