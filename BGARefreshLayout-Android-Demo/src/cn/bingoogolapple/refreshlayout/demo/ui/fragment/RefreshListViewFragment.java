 ...
 */
public class RefreshListViewFragment extends BaseFragment implements
		BGARefreshLayout.BGARefreshLayoutDelegate,
		AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener,
		BGAOnItemChildClickListener, BGAOnItemChildLongClickListener {
	private static final String TAG = RefreshListViewFragment.class
			.getSimpleName();
	...
	protected void processLogic(Bundle savedInstanceState) {
		...
		// BGAMoocStyleRefreshViewHolder(mApp, true);
