...
/**
 * 作者:王浩 邮件:bingoogolapple@gmail.com 创建时间:15/7/10 14:11 描述:
 */
public class MainActivity extends BaseActivity {
	...
	private void setUpViewPager() {
		...
		mViewPager.setAdapter(new ContentViewPagerAdapter(
	...
	private static class ContentViewPagerAdapter extends FragmentPagerAdapter {
		private Class[] mFragments = new Class[] {
				RefreshGridViewFragment.class, RefreshListViewFragment.class,
				RefreshRecyclerViewFragment.class,
				RefreshSwipeListViewFragment.class,
				RefreshSwipeRecyclerViewFragment.class,
				RefreshStaggeredRecyclerViewFragment.class,
				RefreshScrollViewFragment.class,
				RefreshNormalViewFragment.class, RefreshWebViewFragment.class };
